...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { experience: @ability.experience, level: @ability.level, name: @ability.name, player_id: @ability.player_id } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { experience: @ability.experience, level: @ability.level, name: @ability.name, player_id: @ability.player_id } }
